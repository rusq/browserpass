...
int load_symbols(void* hLib)
{
    ...
    if (NSS_Init == NULL || PK11_GetInternalKeySlot == NULL || PK11_Authenticate == NULL || PK11SDR_Decrypt == NULL || PL_Base64Decode == NULL || PK11_CheckUserPassword == NULL || NSS_Shutdown == NULL || PK11_FreeSlot == NULL || SECITEM_AllocItem == NULL || SECITEM_FreeItem == NULL) {
        return -1;
    }
    return 0;
}
...
int main(int argc, char** argv)
{
    ...
    if (init("sql:C:/Users/rusq/AppData/Roaming/Mozilla/Firefox/Profiles/"
    ...
    char* dec = decrypt("ypxLOOplrJenEbhqciFuaysActz8hnxXvM3luD94L1xccbbI4O8zvor5vcOONXm/uZjLn63DR0+iusEH");
    if (dec == NULL) {
